...
# Config Files
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/lenovo/armani/system,system)

PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/lenovo/armani/rootdir,root)
